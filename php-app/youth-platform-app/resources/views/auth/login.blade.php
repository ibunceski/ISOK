...
@section('title', 'Login - Youth Safety Platform')
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8">
            <div class="text-center">
                ...
                <p class="text-blue-100 mt-1">Access the reporting dashboard</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="admin@youthplatform.com"
                    >
                </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <p class="text-center text-sm text-gray-500">
                <a href="{{ route('reports.create') }}" class="text-blue-600 hover:text-blue-700 font-medium">
                    &larr; Back to Report Submission
                </a>
            </p>
        </div>
    </div>
